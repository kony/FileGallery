define({
    ...
    apiData: [{
            ...
            "Description": "In iOS apps, Action Sheets implement pop-up menus that enable users to select actions. They can also be used for notification dialog boxes or alert boxes.",
            "DocLink": 'Please find it documented in Kony Documentation here<br> <a href = "http://docs.kony.com/konylibrary/visualizer/viz_api_dev_guide/content/actionsheet_object.htm">Action Sheet</a>',
            "CodeSnippet": '<label style=color:#4e5221>/*<br>To create action items for Action Sheet<br>*/<br></label><label style=color:#103070>actionItem1 = new kony.ui.ActionItem(<br>{<br>"title":"Cancel",<br>"style":constants.ACTION_ITEM_STYLE_DEFAULT,<br>"action":function(){ }<br>}<br>);<br>actionItem2 = new kony.ui.ActionItem(<br>{<br>"title":"Play",<br>"style":constants.ACTION_ITEM_STYLE_DEFAULT,<br>"action":function(){ }<br>}<br>);<br></label><label style=color:#4e5221>/*<br>To create Actionsheet object<br>*/<br></label><br><label style=color:#103070>actionSheetObject = new kony.ui.ActionSheet(<br>{<br>"title":"Alert",<br>"message":"Message",<br>"showCompletionCallback": function(){}<br>}<br>actionSheetObject.addAction(actionItem1);<br>actionSheetObject.addAction(actionItem2);<br>actionSheetObject.show();<br></label>' 
         },
        {
            "APIName": "Battery API",
            ...
            "DocLink": 'Please find it documented in Kony Documentation here<br> <a href = "http://docs.kony.com/konylibrary/visualizer/viz_api_dev_guide/Default.htm#battery_api.htm%3FTocPath%3DOverviews%7C_____10">Battery API</a>',
            "CodeSnippet": '<p>"The current application uses battery level and state to enable playing of an audio"<br>"For any battery level below 20 %, the app wont allow playing of the audio file"<br>"For battery level between 20 % to 30 %, the app will alert the user about the battery level and ask what the user wants to do"<br>"Otherwise, the audio will play seamlessly"<br>"If the battery state is charging, the above conditions wont hold good and the audio will play seamlessly"<br><h5>To get Battery Level percentage</h5><br><label style=color:#103070><br>function getBatteryLevel()<br>{<br>kony.os.getBatteryLevel();<br>}<label><br><h5>To get Battery State</h5><br><label style=color:#103070><br>function getBatteryLevel()<br>{<br>kony.os.getBatteryState();<br>}<br></label><br><br>'
        }, {
        ...
        },
        {
            ...
            "DocLink": 'Please find it documented in Kony Documentation here<br><a href = "http://docs.kony.com/konylibrary/visualizer/viz_api_dev_guide/Default.htm#imageapi.htm%3FTocPath%3DOverviews%7C_____24">Image API</a>',
        ...
        },
        {
            ...
            "DocLink": 'Please find it documented in Kony Documentation here<br> <a href = "http://docs.kony.com/konylibrary/visualizer/viz_api_dev_guide/Default.htm#media_api.htm%3FTocPath%3DOverviews%7C_____33">Media API</a>',
    ...
    showAccord: function(id) {
            ...
            if (this.previosAcc !== null && this.previosAcc !== id) {
                this.view["btnAccordian" + this.previosAcc].src = "chevron_normal.png";
                this.view["lblAccordian" + this.previosAcc].skin = "sknIndexUnselected";
                this.view["btnAccordian" + id].src = "chevron_down.png";
                this.view["lblAccordian" + id].skin = "sknIndexSelected";
                ...
                if (this.view["btnAccordian" + id].src == "chevron_down.png") {
                    ...
                    this.view["lblAccordian" + this.previosAcc].skin = "sknIndexSelected";
                    this.view["btnAccordian" + id].src = "chevron_normal.png";
                    this.view["lblAccordian" + id].skin = "sknIndexUnselected";
    ...
    resetDescScreen: function() {
        for (i = 1; i <= 3; i++) {
            this.view["btnAccordian" + i].src = "chevron_normal.png";
