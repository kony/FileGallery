    ...
    data: [{
        ...
        },
        {
        ...
        },
         {
            ...
            "CodeSnippet": '<label style=color:#f2f1f1>/*<br>To create action items for Action Sheet<br>*/<br></label><label style=color:#ffffff>actionItem1 = new kony.ui.ActionItem(<br>{<br>"title":"Cancel",<br>"style":constants.ACTION_ITEM_STYLE_DEFAULT,<br>"action":function(){ }<br>}<br>);<br>actionItem2 = new kony.ui.ActionItem(<br>{<br>"title":"Play",<br>"style":constants.ACTION_ITEM_STYLE_DEFAULT,<br>"action":function(){ }<br>}<br>);<br></label><label style=color:#f2f1f1>/*<br>To create Actionsheet object<br>*/<br></label><br><label style=color:#ffffff>actionSheetObject = new kony.ui.ActionSheet(<br>{<br>"title":"Alert",<br>"message":"Message",<br>"showCompletionCallback": function(){}<br>}<br>actionSheetObject.addAction(actionItem1);<br>actionSheetObject.addAction(actionItem2);<br>actionSheetObject.show();<br></label>' 
         },
        {
            "APIName": "Toast",
            ...
            "DocLink": 'Please find it documented in Kony Documentation here<br> <a href = "http://docs.kony.com/konylibrary/visualizer/viz_api_dev_guide/Default.htm#toast_api.htm%3FTocPath%3DOverviews%7C_____50">Toast</a>',
