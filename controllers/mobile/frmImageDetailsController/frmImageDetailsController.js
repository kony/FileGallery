define({
    ...
    onNavigate: function(imageName) {
      ...
      if(kony.os.deviceInfo().name === "android" && (kony.application.getPreviousForm() === null || kony.application.getPreviousForm() === "frmLandingPage"))
        this.showToast("Showing Image using Image API");
    },
    /*
     	@Function showToast
    ...
    */
    ...
    data: [{
        ...
        },
        {
            ...
            "DocLink": 'Please find it documented in Kony Documentation here<br><a href = "">Navigation Bar</a>',
